Ext.define('SDT.override.ActionColumn', {
    override : 'Ext.grid.column.Action',

    iconTpl : '<tpl for=".">' +
        '<tpl if="glyph">' +
            '<div class="{cls}" style="display: inline; padding: 0 2px; font-family:{glyphFamily}; font-size:13px; line-height: 15px;"<tpl if="tooltip"> data-qtip="{tooltip}"</tpl>>&#{glyph};</div>' +
        '<tpl else>' +
