Ext.define('SDT.controller.dashboardAdmin.DashboardUserCriteriaController', {
    ...
    init: function () {
        ...
        me.control({
            ...
            'addEditIndependentChartForm[type="Edit"] addEditIndependentChartForm': {
                beforerender: me.loadUserCriteriaIndependentGrid
            },
            'userCriteriaContainer field[name="userCriteriaFields"]': {
                afterrender: me.bindCriteriaDataChangedEvent
            },
            'addEditIndependentChartForm userCriteriaContainer field[name="userCriteriaFields"]': {
                afterrender: me.bindIndependentCriteriaDataChangedEvent
            },
    ...
    bindIndependentCriteriaDataChangedEvent: function (field) {
        var me = this,
            data,
            userCriteriaGrid = field.up('form').down('userCriteriaGrid'),
            store = userCriteriaGrid.getStore(),
    ...
    loadUserCriteriaIndependentGrid: function (formPanel) {
        var me = this,
        ...
        field.on('change', function (field, newValue, oldValue) {
            me.loadUserCriteriaGridFromField(newValue, store);
        }, me, { single: true });
    },
